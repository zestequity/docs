---
title: "Introduction"
description: "Zest Partner API — programmatic access to SPV creation, investor onboarding, and subscription processing for Zest Equity's regulated private-market platform."
---
...
| Environment | URL |
| ----------- | --- |
| Production | `https://api.zestequity.com` |
| Sandbox | `https://sandbox.api.zestequity.com` |

## Get help

- Email: [partners@zestequity.com](mailto:partners@zestequity.com)
- Status: [https://status.zestequity.com](https://status.zestequity.com)
