...
Slugs Zest returns (`opportunitySlug`, `vehicleSlug`, `spSlug`, `spcSlug`, `subscriptionSlug`) are opaque UUID v7 strings. **Don't parse them** — they have no internal structure.
...
"materialisedRefs": {
  ...
  "spcSlug":         "06a04437-d4f2-7553-8000-a91e2b87c346"
}
```
