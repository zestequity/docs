...
If your integration needs to support a deal structure outside the template you were assigned, contact `partners@zestequity.com` so we can scope a template update or a new template version.
